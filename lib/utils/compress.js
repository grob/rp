...
// this is a copy of fs.join with a hardcoded forward slash
// as path separator - unfortunately fs.join uses `File.separator`,
// so .zip files created on windows won't decompress correctly
// on *nix.
var join = function() {
