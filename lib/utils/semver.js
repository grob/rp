export("isEqual", "isGreater", "isGreaterOrEqual", "isLower", "isLowerOrEqual",
        "satisfies", "parseVersion", "parseRange", "sanitizeVersion",
        "sanitizeRange", "cleanVersion", "sort", "getSorter", "isCompatible");
...
var isEqual = function(versionA, versionB) {
 ...
 * @type Boolean
 */
var isCompatible = function(versionA, versionB) {
