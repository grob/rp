...
const ENGINE_VERSION = semver.cleanVersion(engine.version.join("."));

export("isActivated", "isInstalled", "install", "uninstall", "activate",
        "deactivate", "getDescriptor", "getPackagesDir", "getInstallDir",
        "resolveDependencies", "getInstalledVersions",
        "getLatestInstalledVersion", "getActivatedVersion", "isManaged",
