...
export("check", "sanitize", "checkName", "checkVersion", "checkDescription",
        ...
        "checkEngineDependency", "checkKeywords", "sanitizeKeywords",
        "checkAuthor", "checkAuthorData", "sanitizeAuthor",
        "checkHashList", "sanitizeHashList",
        "checkRepositories", "sanitizeRepositories",
        "checkLicenses", "sanitizeLicenses"
);
...
var check = function(desc) {
    try {
        ...
        checkRepositories(desc.repositories);
        checkLicenses(desc.licenses);
        if (desc.author != null) {
...
var checkHashList = function(arr, name, requiredProps) {
...
var sanitizeHashList = function(arr, props) {
...
var checkRepositories = function(repositories) {
    return checkHashList(repositories, "repository", ["type", "url"]);
};

var sanitizeRepositories = function(repositories) {
    sanitizeHashList(repositories, ["type", "url"]);
};

var checkLicenses = function(licenses) {
    return checkHashList(licenses, "repository", ["type", "url"]);
};

var sanitizeLicenses = function(licenses) {
