...
exports.publish = function(args) {
    ...
    var password = shell.readln("Password: ", "*");
    var digest = crypto.createDigest(password, strings.b64decode(salt, "raw"));
    // data sent to registry
    var data = {
