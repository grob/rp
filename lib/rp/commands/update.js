...
exports.description = "Updates activated or installed packages";
...
exports.help = function help() {
    ...
    term.writeln("\nIf using -i, updated packages will not be activated automatically");
    term.writeln();
    return;
};
...
var activatePackage = function(descriptor) {
    ...
    term.writeln(term.GREEN, "Activated", descriptor.name, descriptor.version, term.RESET);
